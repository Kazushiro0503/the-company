<?php
    session_start(); 
    $success = "<p class='alert alert-success text-center'>Photo Upload successfully. </p>"; 
...
<body>
    ...
    <main class="card w-25 mx-auto my-5">
        <img src="../images/<?= $user_details["photo"]?>" alt="Profile Picture" class="card-image-top">
        <!-- ƒor the alt, you can also echo the same of the logged in user -->
        <div class="card-body">
            <form action="../actions/upload-photo.php" method="post" enctype="multipart/form-data">
            <!-- encotype = encoding (transformed) type  -->
                <div class="custom-file mb-2">
                    <label for="photo" class="custom-file-label">Choose Photo</label>
                    <input type="file" name="photo" id="photo" class="file custom-file-input" required>
                </div>
